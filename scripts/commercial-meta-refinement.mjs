...
const descriptions = {
  ...
  'ru/index.html': 'Структурирование международного бизнеса: архитектура группы, управление, substance и банковская готовность с координацией налоговых и регуляторных выводов.',
  ...
  'ru/ekspertiza/bankovskaya-gotovnost.html': 'Подготовка международной структуры к банковскому onboarding: бизнес-модель, ownership, substance, KYC/KYB и доказательства Source of Funds / Source of Wealth.',
  ...
  'ru/ekspertiza/regulyatornaya-arhitektura-i-licenzirovanie.html': 'Регуляторная архитектура для платежных, crypto и иных регулируемых моделей: карта деятельности, лицензионный периметр и подтверждение локальных требований.',
  'ru/ekspertiza/chastnyy-kapital-i-family-office.html': 'Структурирование частного капитала и family office: владение, governance, банковские вопросы, преемственность и координация профильных специалистов.',
  'ru/formaty-raboty/strategicheskiy-strukturnyy-audit.html': 'Системный аудит международной структуры: ownership, налоговые интерфейсы, substance, банковская готовность, governance и регуляторные зависимости.',
