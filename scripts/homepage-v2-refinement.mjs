...
const CFG = {
  ...
  ru: {
    ...
    flagship: {
      ...
      subtitle: 'Мы рассматриваем владение, управление, налоговые интерфейсы, банковскую логику, governance и доказательную базу как одну систему. Выводы по праву и налогам конкретной юрисдикции при необходимости координируются с квалифицированными профильными специалистами.',
      lines: [
        'Архитектура бизнеса → владение, роли компаний, управление и реальные потоки',
        'Трансграничные риски → налоговое резидентство, КИК, PE, VAT и treaty-интерфейсы',
        'Банки и капитал → KYC/AML, Source of Funds / Source of Wealth и объяснимость потоков',
        'Governance и доказательства → полномочия, решения, substance и подтверждающие документы'
      ],
    ...
    deliverables: {
      ...
      cards: [
        ...
        ['Карта рисков и зависимостей', 'Трансграничные интерфейсы, требующие внимания: налоговые, PE/VAT, банковские, governance или регуляторные.'],
        ['Governance и доказательная база', 'Полномочия, история решений, банковская логика и документы, подтверждающие фактическую работу модели.'],
        ['План реализации', 'Приоритетная последовательность изменений, профильных workstreams и документов для внедрения.']
      ]
    }
  },
  uk: {
    ...
    flagship: {
      ...
      subtitle: 'Ми розглядаємо володіння, управління, податкові інтерфейси, банківську логіку, governance і доказову базу як одну систему. Висновки щодо права та оподаткування конкретної юрисдикції за потреби координуються з кваліфікованими профільними фахівцями.',
      lines: [
        'Архітектура бізнесу → володіння, ролі компаній, управління та реальні потоки',
        'Транскордонні ризики → податкове резидентство, КІК, PE, VAT і treaty-інтерфейси',
        'Банки й капітал → KYC/AML, Source of Funds / Source of Wealth та пояснюваність потоків',
        'Governance і докази → повноваження, рішення, substance та підтвердні документи'
      ],
    ...
    deliverables: {
      ...
      cards: [
        ...
        ['Карта ризиків і залежностей', 'Транскордонні інтерфейси, що потребують уваги: податкові, PE/VAT, банківські, governance або регуляторні.'],
        ['Governance і доказова база', 'Повноваження, історія рішень, банківська логіка та документи, що підтверджують фактичну роботу моделі.'],
        ['План реалізації', 'Пріоритетна послідовність змін, профільних workstreams і документів для впровадження.']
      ]
    }
  }
};
